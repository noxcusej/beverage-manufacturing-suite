  ...
  return (
    <div className="main-container">
      <div style={{ background: '#eff6ff', border: '1px solid #bfdbfe', color: '#1e40af', padding: '8px 12px', borderRadius: 6, marginBottom: 12, fontSize: 12 }}>
        This is a reference <strong>catalog</strong> of service-fee templates. Items here aren't auto-applied to quotes —
        open <strong>Run Quoting</strong> and use the <em>+ From catalog…</em> picker on the Tolling, BOM, or Tax tables to pull them into a quote.
      </div>
