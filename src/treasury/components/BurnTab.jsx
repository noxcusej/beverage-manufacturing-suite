                ...
                return rows.map((l, i) => (
                  <tr key={l ? l.id : cat + "-empty"} className="evrow">
                    ...
                    {l ? (<>
                      ...
                      <td><select className="sel" value={l.cadence || "monthly"} onChange={(e) => setL(l.id, "cadence", e.target.value)}><option value="monthly">Monthly</option><option value="quarterly">Quarterly</option><option value="annual">Annual</option><option value="one-time">One-time</option></select></td>
